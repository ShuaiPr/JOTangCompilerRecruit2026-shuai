...
#line 247 "include/yacc/Bison.hpp"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_VarDef = 50,                           // VarDef
        S_FuncDef = 51,                          // FuncDef
        S_FuncParamList = 52,                    // FuncParamList
        S_FuncParam = 53,                        // FuncParam
        S_Block = 54,                            // Block
        S_BlockItemList = 55,                    // BlockItemList
        S_BlockItem = 56,                        // BlockItem
        S_Stmt = 57,                             // Stmt
        S_Exp = 58,                              // Exp
        S_Cond = 59,                             // Cond
        S_LVal = 60,                             // LVal
        ...
        S_Number = 62,                           // Number
        S_UnaryExp = 63,                         // UnaryExp
        S_FuncRParams = 64,                      // FuncRParams
        S_ArrayList = 65,                        // ArrayList
        S_ArrayDims = 66,                        // ArrayDims
        S_InitVal = 67,                          // InitVal
        S_InitValList = 68,                      // InitValList
        S_MulExp = 69,                           // MulExp
        S_AddExp = 70,                           // AddExp
        S_RelExp = 71,                           // RelExp
        S_EqExp = 72,                            // EqExp
...
#line 906 "include/yacc/Bison.hpp"
